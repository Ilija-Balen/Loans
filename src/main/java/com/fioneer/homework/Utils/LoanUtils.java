...
public class LoanUtils {
    ...
    public static final String LOAN_FOUND_CODE = "000";
    public static final String LOAN_FOUND_MESSAGE = "LOAN FOUND SUCCESSFULLY";
    public static final String LOAN_CREATED_CODE = "004";
    public static final String LOAN_CREATED_MESSAGE = "LOAN CREATED SUCCESSFULLY";
    public static final String LOAN_EXISTS_CODE = "001";
    public static final String LOAN_EXISTS_MESSAGE = "LOAN ALREADY EXISTS";
    public static final String STEP_EXISTS_CODE = "002";
